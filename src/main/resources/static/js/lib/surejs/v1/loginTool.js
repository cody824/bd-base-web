$.cachedScript("/js/lib/jquery/plugin/jquery.cookie.js");
$.cachedScript("/js/lib/surejs/v1/sureAjax.js");
$.cachedScript("/js/lib/surejs/v1/sureMsg.js");

function LoginUtil(option){
	var me = this;
	...
	this.bindAuthcodeInputEvent = function(imgId, inputId, statusId){
		...
		if (imgEl)
			imgEl.attr("src", me.authcodeurl + "?clientId=" + browserClientId + "&_r=" + random_number);
		if (inputEl) {
